...
Скилл, шкалы, примитивы раскладки и пятнадцать проверок — то, что
...
| | |
|---|---|
| \`.claude/skills/craft/\` | свой скилл: семь запретов, три шкалы, пять примитивов, пятнадцать проверок |
