...
export const STAGES = [
  ...
  },
  {
    ...
    parked: [
      { name: 'Frontend Visual QA — оставшиеся семьи', url: 'docs/skills.md',
        take: 'четыре семьи в check:craft ещё не заведены: <div onClick> без роли, надпись контрола в две строки, движение без учёта настройки системы. Мета окна — уже в check:seo.' },
    ],
  },
  {
    n: 3, name: 'Поведение',
